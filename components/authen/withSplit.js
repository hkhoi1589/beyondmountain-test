...
export default function Authen({ className = '' }) {
	return (
		<main className={`w-full flex ${className}`}>
				...
				<div className='relative z-10 w-full max-w-md text-white'>
					...
					<div className='mt-16 space-y-3'>
						...
						<p className='opacity-70'>
							Create an account and get access to all features for 30-days, No credit
							card required.
						</p>
				...
				<div className='w-full max-w-md space-y-8 px-4 bg-base-100 sm:px-0'>
					<div>
						...
						<div className='mt-5 space-y-2'>
							<h3 className='opacity-90 text-2xl font-bold sm:text-3xl'>Sign up</h3>
							<div>
