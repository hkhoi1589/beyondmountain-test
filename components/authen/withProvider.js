...
export default function Authen({ className = '' }) {
	return (
		<section
			className={`w-full h-screen flex flex-col items-center justify-center sm:px-4 ${className}`}>
			<div className='w-full space-y-6 sm:max-w-md'>
				...
				<div className='bg-base-100 shadow p-4 py-6 space-y-8 sm:p-6 sm:rounded-lg'>
