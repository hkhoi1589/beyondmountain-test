        ...
        <ul className="grid gap-6 sm:grid-cols-2">
          ...
          <li className="bg-purple-50 p-8 rounded-box">
            <figure className="space-y-4">
              ...
              <p>
                Create beautiful websites and apps with an intuitive design for
                your users.
              </p>
            </figure>
          </li>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <div className="flex rounded-box bg-[#EFC9A6] aspect-square overflow-hidden">
            ...
            <div className="w-2/5 flex items-end p-4">
              ...
              Around the world, exclusion and discrimination continue to divide
              people. We act now.
            </div>
          </div>
          <div className="flex flex-col rounded-box bg-[#EFABA6] aspect-square overflow-hidden">
            <div className="p-4">
              Language is the key to understanding: Across borders and cultures.
              We offer the possibility to learn English as a second language in
              a social setting.
            </div>
          ...
          <div className="flex rounded-box bg-[#89BCC4] aspect-square overflow-hidden">
            <div className="w-2/5 flex items-end p-4 text-right">
              Beyond Mountain is a non-profit organization. As such, we are at
              the service of society. Do you want to support us in our mission?
              Get in contact!
            </div>
