	...
	return (
		<section id='team' className={`py-28 ${className}`}>
			...
			<div
				...
				<div className='dropdown dropdown-bottom'>
					<label tabindex='0'>
						<img src='/img/avatar/user-4.jpg' className='pic-circle w-72 ring-4' />
					</label>
					<div className='dropdown-content z-10 rounded-lg bg-white/50 backdrop-blur p-4 mt-6 text-lg'>
						Edouard Ollivier
						<p className='text-sm opacity-60'>
				...
				<div className='dropdown dropdown-bottom'>
					<label tabindex='0'>
						<img src='/img/avatar/a-1.jpg' className='pic-circle ring-4 ring-primary' />
					</label>
					<div className='dropdown-content z-10 rounded-lg bg-white/50 backdrop-blur p-4 mt-6 text-lg'>
						Edouard Ollivier
						<p className='text-sm opacity-60'>
				...
				<div className='dropdown dropdown-bottom'>
					<label tabindex='0'>
						<img src='/img/avatar/a-5.jpg' className='pic-circle ring-4 ring-success' />
					</label>
					<div className='dropdown-content z-10 rounded-lg bg-white/50 backdrop-blur p-4 mt-6 text-lg'>
						Edouard Ollivier
						<p className='text-sm opacity-60'>
