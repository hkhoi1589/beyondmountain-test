          ...
          {plans.map((item, idx) => (
            ...
            >
              <div>
                ...
                <div className="mt-4 opacity-90 text-3xl font-semibold">
                  ${item.price}{" "}
              ...
              <div className="flex-1 flex items-end">
                <button className="px-3 py-3 rounded-lg w-full font-semibold text-sm duration-150 text-white bg-primary hover:bg-primary active:bg-indigo-700">
                  Get Started
                </button>
              </div>
            </div>
