    ...
    <section className={`py-14 ${className}`}>
      <div className="">
        <div className="relative max-w-xl mx-auto space-y-3 px-4 sm:text-center md:px-0">
          ...
          <p className="opacity-80 text-3xl font-semibold sm:text-4xl">
        ...
        <div className="mt-16">
          <div className="sticky top-0 py-6 border-t border-b bg-base-300/30 backdrop-blur-lg">
                  ...
                  <tr>
                    <th className="z-20 top-12 py-6 lg:sticky">
                      <div className="flex items-center gap-x-3">
                        <div className="w-12 h-12 text-primaryrounded-full border flex items-center justify-center">
                          {table.label_icon}
                        </div>
                        <h4 className="opacity-90 text-xl font-medium">
                          {table.label}
                        </h4>
                      </div>
                    </th>
