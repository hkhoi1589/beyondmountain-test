      ...
      <div className="relative z-10 max-w-screen-xl mx-auto px-4 justify-between items-center gap-12 md:px-8 md:flex">
        ...
        <div className="flex-1 mt-6 md:mt-0">
          <form className="flex items-center gap-x-3 md:justify-end">
            ...
            <button className="block w-auto py-3 px-4 font-medium text-sm text-center text-white bg-primary hover:bg-primary active:bg-indigo-700 active:shadow-none rounded-lg shadow">
              Subscribe
            </button>
          </form>
        </div>
      </div>
      <BG className="h-[300px]" />
    </section>
  );
}
