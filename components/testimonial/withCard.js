        ...
        <div className="mt-12">
          <ul className="grid items-center gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {testimonials.map((item, idx) => (
              <li
                key={idx}
                className="rounded-xl overflow-hidden border border-neutral shadow-md"
              >
                <div className="p-4">
                  <svg
                    className="w-9 h-9"
                ...
                <figure>
                  <blockquote>
                    <p className="opacity-90 text-lg font-semibold px-4 py-1">
                      {item.quote}
                    </p>
                  </blockquote>
                  <div className="flex items-center gap-x-4 p-4 mt-6 bg-base-100">
                    ...
                    <div>
                      ...
                      <span className="block text-primary text-sm mt-0.5">
                        {item.title}
                      </span>
                    </div>
                  </div>
