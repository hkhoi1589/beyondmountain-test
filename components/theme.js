...
export default function Theme({ theme = "light" }) {
  ...
  return (
    <div data-theme={theme} className="bg-transparent">
      <div className="bg-base-100 text-base-content not-prose grid gap-3 p-6">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="bg-base-100 border border-neutral-focus">
            base-100
            <div className="bg-base-200 mt-4 px-4">
              base-200
              <div className="bg-base-300 mt-4 pb-4 px-4">base-300</div>
            </div>
          </div>
        </div>
      </div>
